...
export default function HomePageClient({ useCases }) {
      ...
      <div className="container">
        <header className={`site-header${isMobileMenuOpen ? " mobile-menu-open" : ""}`}>
          ...
          <nav className="desktop-nav" aria-label="Primary">
            <a href="/" onClick={(event) => { event.preventDefault(); scrollToSection("services"); }}>Services</a>
            <a href="/" onClick={(event) => { event.preventDefault(); scrollToSection("process"); }}>Process</a>
            <a href="/" onClick={(event) => { event.preventDefault(); scrollToSection("use-cases"); }}>Use Cases</a>
            <a href="/" onClick={(event) => { event.preventDefault(); scrollToSection("contact"); }}>Contact</a>
          </nav>
          ...
          {isMobileMenuOpen ? (
            <div id="mobile-navigation-panel" className="mobile-menu-panel">
              <nav className="mobile-nav" aria-label="Mobile">
                <a href="/" onClick={(event) => { event.preventDefault(); setIsMobileMenuOpen(false); scrollToSection("services"); }}>Services</a>
                <a href="/" onClick={(event) => { event.preventDefault(); setIsMobileMenuOpen(false); scrollToSection("process"); }}>Process</a>
                <a href="/" onClick={(event) => { event.preventDefault(); setIsMobileMenuOpen(false); scrollToSection("contact"); }}>Contact</a>
              </nav>
